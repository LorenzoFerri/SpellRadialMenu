...
CachedReadableRegion g_cs_fe_man_static_region = {};
CachedReadableRegion g_cs_fe_man_hud_region = {};
...
std::uintptr_t ResolveCSFeMan()
{
    ...
    return ReadCachedMemory(g_cs_fe_man_static_address, fe_man, g_cs_fe_man_static_region) ? fe_man : 0;
}
...
bool RefreshNormalGameplayHudState()
{
    ...
    if (!ReadCachedMemory(fe_man + kHudStateOffset, hud_state, g_cs_fe_man_hud_region)) {
